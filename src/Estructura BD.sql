...
CREATE TABLE `Cursos`(
  ...
  `CATEDRATICO` MEDIUMINT(8) UNSIGNED NOT NULL COMMENT 'Catedrático que imparte el Curso.',
...
--
ALTER TABLE
  `Catedratico` ADD PRIMARY KEY(`SQLID`) COMMENT 'Clave principal que sirve como índice en SQL.',
...
--
ALTER TABLE
  `Alumnos` MODIFY `SQLID` MEDIUMINT(7) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Clave principal con autoincremento.';

--
-- AUTO_INCREMENT for table `Catedratico`
--
ALTER TABLE
  `Catedratico` MODIFY `SQLID` MEDIUMINT(7) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Clave principal con autoincremento.';

--
-- AUTO_INCREMENT for table `Cursos`
--
ALTER TABLE
  `Cursos` MODIFY `SQLID` MEDIUMINT(8) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Clave principal con autoincremento.';
...
--
ALTER TABLE
  `Alumnos-Cursos-Aprobados` ADD CONSTRAINT `Alumnos-Cursos-Aprobados_ibfk_1` FOREIGN KEY(`Curso`) REFERENCES `Cursos`(`SQLID`),
  ADD CONSTRAINT `Alumnos-Cursos-Aprobados_ibfk_2` FOREIGN KEY(`Alumno`) REFERENCES `Alumnos`(`SQLID`);
...
--
ALTER TABLE
  `Alumnos-Cursos-Corrientes` ADD CONSTRAINT `Alumnos-Cursos-Corrientes_ibfk_1` FOREIGN KEY(`Curso`) REFERENCES `Cursos`(`SQLID`),
  ADD CONSTRAINT `Alumnos-Cursos-Corrientes_ibfk_2` FOREIGN KEY(`Alumno`) REFERENCES `Alumnos`(`SQLID`);
...
--
ALTER TABLE
  `Alumnos-Cursos-Reprobados` ADD CONSTRAINT `Alumnos-Cursos-Reprobados_ibfk_1` FOREIGN KEY(`Curso`) REFERENCES `Cursos`(`SQLID`),
  ADD CONSTRAINT `Alumnos-Cursos-Reprobados_ibfk_2` FOREIGN KEY(`Alumno`) REFERENCES `Alumnos`(`SQLID`);
...
--
ALTER TABLE
  `Auxiliares-Cursos` ADD CONSTRAINT `Auxiliares-Cursos_ibfk_1` FOREIGN KEY(`Curso`) REFERENCES `Cursos`(`SQLID`),
  ADD CONSTRAINT `Auxiliares-Cursos_ibfk_2` FOREIGN KEY(`Auxiliar`) REFERENCES `Alumnos`(`SQLID`);
...
--
ALTER TABLE
  `Cursos` ADD CONSTRAINT `Cursos_ibfk_1` FOREIGN KEY(`CATEDRATICO`) REFERENCES `Catedratico`(`SQLID`);
...
--
ALTER TABLE
  `Tutores-Cursos` ADD CONSTRAINT `Tutores-Cursos_ibfk_1` FOREIGN KEY(`Curso`) REFERENCES `Cursos`(`SQLID`),
  ADD CONSTRAINT `Tutores-Cursos_ibfk_2` FOREIGN KEY(`Tutor`) REFERENCES `Alumnos`(`SQLID`) ON DELETE CASCADE ON UPDATE CASCADE;
SET
